...
<body>
    <div class="login-container">
        ...
        @endif
        <form action="{{ route('CongTung.Guest.Login') }}" method="POST">
            @csrf
            <div class="mb-3">
                <label for="ctEmail" class="form-label">Email</label>
                <input type="text" name="ctEmail" id="ctEmail" class="form-control" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3 form-check">
                ...
                <a href="/ctGuest/ct-create">Đăng Ký</a>
            </div>
